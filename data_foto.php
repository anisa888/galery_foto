	   ...
	   <div class="row">
        <div class="col-md-12">
		  ...
		  <thead align="center">
			...
			<a href = "print_data_foto.php" class="btn btn-sm btn-primary">print_data_foto</a>
		  </thead>
		  <tbody  align="center">
			<?php
			include('koneksi.php');
			...
			<tr>
				...
				<?php echo '
				  <a href="delete_foto_admin.php?FotoID='.$data['FotoID'].'" class="btn btn-sm btn-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
				  ';?>
				</td>
			</tr>
			<?php
